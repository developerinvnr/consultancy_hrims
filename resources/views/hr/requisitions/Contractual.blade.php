    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">HR Create Contractual Requisition</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="card-title mb-0">Contractual Requisition Form (HR Create)</h5>
                        </div>
                        <div class="col-md-6">
                    ...
                    <form id="requisition-form" method="POST" action="{{ route('hr_requisitions.direct.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6 mb-3">
                                                <label for="other_reimbursement_required" class="form-label">Fuel & Other Reimbursement Required? <span class="text-danger">*</span></label>
                                                <select class="form-select form-select-sm" id="other_reimbursement_required" name="other_reimbursement_required" required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="out_of_pocket_required" class="form-label">Out of Pocket Expense Required? <span class="text-danger">*</span></label>
                                                <select class="form-select form-select-sm" id="out_of_pocket_required" name="out_of_pocket_required" required>
                                                    <option value="">Select</option>
                                                    <option value="Y">Yes</option>
                                                    <option value="N">No</option>
                                                </select>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card border">
                                    <div class="card-header bg-light py-2">
                                        <h6 class="mb-0">Section 4: Document Uploads</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <!-- Resume -->
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <small class="text-muted">Clear image/PDF</small>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control form-select-sm"
                                                    id="pan_no" name="pan_no" maxlength="10" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control form-select-sm"
                                                    id="aadhaar_no" name="aadhaar_no" maxlength="12" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control form-select-sm"
                                                    id="bank_account_no" name="bank_account_no" maxlength="50" required>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control form-select-sm"
                                                    id="bank_ifsc" name="bank_ifsc" maxlength="11" required>

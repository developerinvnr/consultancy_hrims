...
<div class="container-fluid">
    ...
    <div class="col-md-3 mb-3">
        ...
        <select class="form-select form-select-sm" id="reporting_manager_name"
                name="reporting_manager_name" required disabled>
            <option value="">Select Department First</option>
        </select>
    </div>

    <div class="col-md-2 mb-3">
        <label class="form-label">Rep Manager ID <span class="text-danger">*</span></label>
        <input type="number" class="form-control form-select-sm"
               id="reporting_manager_id" name="reporting_manager_id" readonly required>
    </div>

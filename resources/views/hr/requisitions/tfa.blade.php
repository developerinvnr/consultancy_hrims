    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">HR Create TFA Requisition</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="card-title mb-0">Temporary Field Assistant (TFA) Requisition Form (HR Create)</h5>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <form id="requisition-form" method="POST" action="{{ route('hr_requisitions.direct.store') }}" enctype="multipart/form-data">
                        ...
                        <!-- HR Direct Action Section -->
                        {{--<div class="row mb-4">
                            <div class="col-12">
                                <div class="card border border-primary">
                                    <div class="card-header bg-primary text-white py-2">
                                        <h6 class="mb-0">HR Direct Creation</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="alert alert-info mb-0">
                                                    ...
                                                    This requisition will be created with <strong>Approved</strong> status directly.
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" 
                                                        id="create_candidate_master" name="create_candidate_master" value="1" checked>
                                                    <label class="form-check-label" for="create_candidate_master">
                                                        <strong>Create Candidate Master Record</strong>
                                                    </label>
                                                    <small class="text-muted d-block">Employee ID will be generated automatically</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- Section 1: Personal Information (All fields editable for HR) -->
                        <div class="row mb-4">
                            <div class="col-12">
...
<div class="col-md-2 mb-3">
    ...
    <select class="form-select form-select-sm" id="territory" name="territory" disabled>
        <option value="">Select Region First</option>
                        ...
                        <!-- Section 4: Document Uploads with Data Extraction (Same as regular) -->
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card border">
                                    <div class="card-header bg-light py-2">
...
<script>
    ...
    $.ajax({
        ...
        // File processing functions (same as regular form)

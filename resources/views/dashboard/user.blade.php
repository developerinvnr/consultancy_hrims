...
<div class="container-fluid">
	...
	<div class="row mb-3">
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0">Contract Expiry</h5>
				</div>
				...
				<div class="card-body">
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade {{ request('exp_tab','exp30')=='exp30' ? 'show active' : '' }}" id="exp30">
							@include('dashboard.partials.expiry-table', ['list'=>$expiry['lt_30_days']])
						</div>

						<div class="tab-pane fade {{ request('exp_tab')=='exp60' ? 'show active' : '' }}" id="exp60">
							@include('dashboard.partials.expiry-table', ['list'=>$expiry['days_30_60']])
						</div>

						<div class="tab-pane fade {{ request('exp_tab')=='exp90' ? 'show active' : '' }}" id="exp90">

!(function () {
    ...
    // For vertical or semibox layouts
    if (layout === "vertical" || layout === "semibox") {
        ...
        if (navbarMenu && typeof d !== 'undefined') {
            navbarMenu.innerHTML = d;
        }
        
        // Check scrollbar element
    ...
    if (layout === "horizontal") {
        // Check if b() function exists before calling it
    ...
    function e(e) {
        if (e == e) {
            ...
            switch (e["data-layout"]) {
                case "vertical":
                    T("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), s();
                    break;
                case "horizontal":

        ...
        try {
            ...
            $formattedCandidate = [
                ...
                'employment_details' => [
                    ...
                    'date_of_joining' => $candidate->date_of_joining ? Carbon::parse($candidate->date_of_joining)->format('d-m-Y') : 'N/A',
                    'date_of_separation' => $candidate->date_of_separation ? Carbon::parse($candidate->date_of_separation)->format('d-m-Y') : 'N/A',
                    'agreement_duration' => $candidate->agreement_duration ? $candidate->agreement_duration . ' months' : 'N/A',
